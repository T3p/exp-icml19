...
\draw[fill, inner color=poliblue1, outer color=white, draw=none, color=white] (-0.7,-3.5,0) ellipse (1.25 and .4) node[above, shift={(1,.2)}, color=poliblue1]{$p_{\vtheta}$};
\draw[dashed, color=poliblue1] (a) -- (-0.7,-3.5,0);
\draw[color=poliblue1] (-0.7,-5,0) node (c) {$J(\vtheta)$};
