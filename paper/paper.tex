...
\end{restatable}
%
Unfortunately, this algorithm is subject to the curse of dimensionality as the optimization requires time $\mathcal{O}(dt^{\nicefrac{d}{2}+2})$ per iteration, summing up to total time $\mathcal{O}(dT^{\nicefrac{d}{2}+3})$.
\begin{algorithm}[t]
