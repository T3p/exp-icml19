...
the default scikit-learn kernel (RBF) which invalidates all theoretical guarantees, as our payoff is not sampled from a GP.\footnote{Indeed, we empirically discovered that GPUCB tends to be unjustifiably more exploitative than UCB1 and \algoname.}
