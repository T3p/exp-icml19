...
Implementing \algoname or \algoname 2 to solve a policy optimization problem, whether in the action-based or in the parameter-based formulation, requires some additional caveats, discussed in Appendix~\ref{app:practical}.
...
\section{Practical Aspects of \algoname}\label{app:practical}
